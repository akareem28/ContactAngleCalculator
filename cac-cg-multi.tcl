...
# length unit: A
#command example：cac all.psf all.dcd xz 900 1000 20 {index 58158 to 68936} 2 3 6 0.0324 0.1 3 0.5 0.5
...
proc cac {file_1 file_2 type firstFrame lastFrame step dropletAtomRange MolNumberInsystem atomNumberInMol1 dropletAtomRange1 \
          atomNumberInMol2 dropletAtomRange2 dropletMolNumDensity glRatio sphereFactor \
          thicknessFactor sliceFactor} {
...
# $MolNumberInsystem - Number of molecular specious in the system
#
...
puts $logfile "Command: cac $file_1 $file_2 $type $firstFrame $lastFrame $step $dropletAtomRange $MolNumberInsystem $atomNumberInMol1 {$dropletAtomRange1}\
         $atomNumberInMol2 {$dropletAtomRange1} $dropletMolNumDensity $glRatio $sphereFactor \
         $thicknessFactor $sliceFactor"
puts $caFile "  "
puts $caFile "********************** file: $file_1 $file_2 **********************"
puts $caFile  "Command: cac $file_1 $file_2 $type $firstFrame $lastFrame $step $dropletAtomRange $MolNumberInsystem $atomNumberInMol1 {$dropletAtomRange1}\
         $atomNumberInMol2 {$dropletAtomRange1} $dropletMolNumDensity $glRatio $sphereFactor \
         $thicknessFactor $sliceFactor"
...
#indexing atoms in molecule 1
set dropletAtomSet1 [atomselect top "$dropletAtomRange1"]
set dropletAtomNum1 [$dropletAtomSet1 num]
set dropletAtomIndex1 [$dropletAtomSet1 get index]
set dropletMolIndex1 {}
for {set i 0} {$i < $dropletAtomNum1} {incr i $atomNumberInMol1} {
	lappend dropletMolIndex1 [lrange $dropletAtomIndex1 $i [expr {$i+$atomNumberInMol1-1}]]	
}

#indexing atoms in molecule 2
set dropletAtomSet2 [atomselect top "$dropletAtomRange2"]
set dropletAtomNum2 [$dropletAtomSet2 num]
set dropletAtomIndex2 [$dropletAtomSet2 get index]
set dropletMolIndex2 {}
for {set i 0} {$i < $dropletAtomNum2} {incr i $atomNumberInMol2} {
	lappend dropletMolIndex2 [lrange $dropletAtomIndex2 $i [expr {$i+$atomNumberInMol2-1}]]	
}

#grouping the index
set dropletMolIndex [concat $dropletMolIndex1 $dropletMolIndex2 ]
